...
Before running the application, you need to configure your API keys and credentials:
...
📚 **For detailed setup instructions**, see [SECURITY_SETUP.md](project/SECURITY_SETUP.md)
